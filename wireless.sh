...
echo -e "${info_font} Please now disconnect from this router, and connect to your Redmi AX3000."
...
echo -e "${info_font} If the return code is 0, then access this URL:"
...
echo -e "${info_font} If everything is okay, now you can connect to your AX3000 via SSH."
echo -e "${info_font} SSH login password is 5GHz wireless connection password."
echo -e ""
echo -e "${success_font} Thanks for usage."
echo -e "          Staff: yyjdelete, Tianling Shen"
